...
export default function App() {
  ...
  if (takeParams) {
    return (
      <div className="app">
        <TakeTest variantId={takeParams.variantId} initialAttemptId={takeParams.attemptId} />
      </div>
    );
  }
      ...
      <div className="app">
        <header className="app-header">
          <div>
            ...
            <h1 className="app-title">Конструктор вариантов</h1>
          </div>
        </header>
        <VariantList variants={variants} onOpen={openVariant} onCreate={createVariant} loading={listLoading} />
  ...
  return (
    <div className="app">
      <header className="app-header">
        <div>
          <button className="back-btn" onClick={() => setVariant(null)}>← Все варианты</button>
